document.addEventListener('DOMContentLoaded', function() {
    ...
    const feedbacks = {
        ...
        julia_fb_1a: { tipo: 'correto', texto: '<strong>Excelente!</strong><br>Você respondeu à pergunta dela de forma ampla e imediatamente devolveu com uma pergunta investigativa para entender o contexto. É a abordagem consultiva perfeita.' },
        julia_fb_1b: { tipo: 'errado', quote: '<strong>Júlia:</strong> "Google Ads? Mas eu nem sei se é isso que eu preciso..."', texto: '<strong>Calma!</strong><br>Oferecer um produto específico sem saber nada sobre o negócio do cliente é um tiro no escuro. O correto é sempre diagnosticar primeiro.' },
        julia_fb_1c: { tipo: 'errado', quote: '<strong>Júlia:</strong> "Um site? Hmm, talvez, mas meu desafio hoje é outro..."', texto: '<strong>Solução genérica!</strong><br>Vender "um site" não resolve a dor de "conseguir clientes". O correto seria investigar o desafio do cliente antes de propor qualquer ferramenta.' },
        ...
        carlos_fb_1a: { tipo: 'correto', texto: '<strong>Perfeito!</strong><br>Você deu uma resposta geral sobre o que a empresa faz e imediatamente usou uma pergunta de qualificação para entender o momento do cliente. É a melhor forma de iniciar um diagnóstico.'},
        ...
        ricardo_fb_1a: { tipo: 'correto', texto: '<strong>Abordagem perfeita!</strong><br>Você respondeu à pergunta estratégica dele, mostrando os benefícios de um site, e usou isso como uma ponte perfeita para uma pergunta investigativa sobre o processo dele. Isso mostra que você ouve e agrega valor antes de vender.' },
        ricardo_fb_1b: { tipo: 'errado', quote: '<strong>Ricardo:</strong> "Amador? Meu negócio está indo muito bem, obrigado. Não gostei do tom."', texto: '<strong>Confronto Direto!</strong><br>Chamar o método do cliente de "amador" é a forma mais rápida de criar resistência. O correto seria valorizar o sucesso que ele já tem e mostrar como sua solução pode potencializá-lo, e não diminuí-lo.' },
        ricardo_fb_1c: { tipo: 'errado', quote: '<strong>Ricardo:</strong> "Desconto no frete? Mas a minha dúvida não era essa. Eu quero saber a diferença que um site faz para o meu negócio como um todo."', texto: '<strong>Foco no Detalhe, não na Estratégia!</strong><br>O cliente fez uma pergunta ampla sobre o valor de um site. Responder com um benefício muito específico (e secundário) como o frete não responde à dúvida dele e mostra que você não entendeu a real questão.' },
        ...
        gustavo_fb_1a: { tipo: 'correto', texto: '<strong>Jogada de Mestre!</strong><br>Você respondeu à pergunta sobre diferenciais com um benefício que impacta o lucro (frete) e já transformou a resposta em uma pergunta para qualificar o cliente. Perfeito.' },
        gustavo_fb_1b: { tipo: 'errado', quote: '<strong>Gustavo:</strong> "Superior como? Fácil de usar? Isso é muito vago. Preciso de argumentos concretos."', texto: '<strong>Resposta Vaga.</strong><br>Argumentos como "superior" ou "fácil de usar" não convencem um cliente analítico. O correto é apresentar diferenciais concretos e mensuráveis, como o Envio Fácil.' },
        gustavo_fb_1c: { tipo: 'errado', quote: '<strong>Gustavo:</strong> "Orçamento? Eu não perguntei de preço, perguntei sobre diferenciais. Parece que você não ouviu minha pergunta."', texto: '<strong>Foco Errado!</strong><br>O cliente perguntou sobre VALOR (diferenciais) e você respondeu com PREÇO. Isso mostra que você não está ouvindo. O correto seria focar nos benefícios exclusivos da plataforma.' },
